...
const SAVE_DIR = get(ENV, "IDUN_OUTPUT_DIR", "/cluster/work/pederava/idun_output/initialguess_sensitivity")
mkpath(SAVE_DIR)
...
println("\n============================================================")
println("2-D initial-guess sensitivity experiment on Idun")
println("============================================================")
