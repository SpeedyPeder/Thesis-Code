...
function plot_error_heatmap_grid(
    ...
    # With the default four initial guesses, this gives a 2 × 2 figure.
    ncols_local = 2
...
function combine_finished_runs(initial_guesses)
    ...
    if MAKE_PLOTS
        ...
        # ---------------------------------------------------------------------
        # RMSE curves over the full diagnostic window
        # ---------------------------------------------------------------------
        ...
        # ---------------------------------------------------------------------
        # Error-to-truth panels. The truth panel is intentionally removed because
        # these plots show prediction minus truth directly.
        # Red = negative error, blue = positive error.
        # ---------------------------------------------------------------------
        ...
        # ---------------------------------------------------------------------
        # Future validation panels at t = 100 s
        # ---------------------------------------------------------------------
        tval = VALIDATION_END
